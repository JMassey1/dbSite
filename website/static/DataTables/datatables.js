 ...
 *   https://datatables.net/download/#dt/dt-1.11.3/fh-3.2.0/sb-1.3.0/sp-1.4.0
 *
 * Included libraries:
 *   DataTables 1.11.3, FixedHeader 3.2.0, SearchBuilder 1.3.0, SearchPanes 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.11.3/fh-3.2.0/sb-1.3.0/sp-1.4.0",
